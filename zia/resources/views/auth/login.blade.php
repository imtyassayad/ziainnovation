...
<head>
    ...
    <title>Zia Innovation | Singin </title>
                        ...
                        <form class="text-left" method="post" action="{{route('login')}}">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="email" type="text" class="form-control @error('email') is-invalid @enderror" placeholder="e.g John_Doe" value="{{old('email')}}">
                                    @error('email')
